...
const TRANSLATE_PROMPT = [
    ...
    'Respond only in plain-text, no markdown or formatting. Keep each narration in a single line without any line breaks within it. Keep the numeric prefixes (P1, C1, 11, etc.) that appear in the beginning of each narration.',
